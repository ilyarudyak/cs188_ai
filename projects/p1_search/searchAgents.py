...
def manhattanHeuristicCorner(position, corner, info={}):
...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return (self.startingPosition, '0000')
...
def num_non_visited_corners(visited_corners):
    return sum([1 for c in visited_corners if c == '0'])
